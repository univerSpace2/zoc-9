...
-- Update rpc_create_venue to support address
...
begin
  ...
  values (
    ...
    'create_venue',
    '{}'::jsonb,
    jsonb_build_object('name', v_name, 'address', v_address, 'reservation_required', v_reservation_required, 'reservation_url', v_reservation_url),
    auth.uid()
  );
...
-- Update rpc_update_venue to support address
...
begin
  ...
  values (
    ...
    v_venue.id,
    'update_venue',
    jsonb_build_object('name', v_venue.name, 'address', v_venue.address, 'reservation_required', v_venue.reservation_required, 'reservation_url', v_venue.reservation_url),
    jsonb_build_object('name', v_name, 'address', v_address, 'reservation_required', v_reservation_required, 'reservation_url', v_reservation_url),
    auth.uid()
  );
